...
<aside class="w-64 text-white flex flex-col min-h-screen" style="background-color: #05386D;">
    ...
    <nav class="flex-1 p-4 space-y-1">
        ...
        <a href="hr2-ess-leave.php" class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors <?php echo $currentPage == 'hr2-ess-leave.php' ? 'bg-indigo-800 text-white' : 'text-indigo-200 hover:bg-indigo-800/50'; ?>">
            <i class="fas fa-calendar-check w-5"></i>
            <span>ESS Leave & Attendance</span>
        </a>
